...
open class TosViewModel @Inject constructor(private val dataStoreRepository: DataStoreRepository) :
  ...
  open fun hasViewedPromo(promoId: String): Boolean {
    return dataStoreRepository.hasViewedPromo(promoId)
  }

  open fun markPromoViewed(promoId: String) {
    dataStoreRepository.addViewedPromoId(promoId)
  }
}
