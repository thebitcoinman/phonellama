...
/** A composable for model license dialog, shown once before a model is downloaded. */
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState()).weight(1f, fill = false)) {
          Text(
            buildAnnotatedString {
              append("Models are provided under their respective licenses. Please verify the license before use.")
            },
